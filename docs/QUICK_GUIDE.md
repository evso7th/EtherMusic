...
*   **Settings:** Use the `Settings` button at the top of the pad to open a panel where you can change the **Instrument** (`synth`, `organ`, `theremin`, etc.), **Music Key**, and **Music Scale**. 
...
The **Autopilot** feature, which automatically generated music, has been moved to its own dedicated application called **AuraGroove** to allow for more advanced capabilities. EtherMusic is now focused on providing the best manual and semi-automatic creative experience.
