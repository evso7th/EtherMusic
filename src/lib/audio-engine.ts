...
export class AudioEngine {
    ...
    private createPresets() {
        this.presets = {
            ...
            ebass: { type: 'FMSynth', options: { harmonicity: 1, modulationIndex: 3.5, oscillator: { type: 'sine' }, envelope: { attack: 0.01, decay: 0.3, sustain: 0, release: 0.1 }, modulation: { type: 'square' }, modulationEnvelope: { attack: 0.01, decay: 0.2, sustain: 0, release: 0.1 } } },
