...
export class AudioEngine {
    ...
    public async initialize() {
        ...
        console.log('[2. ENGINE] Creating synth channels');
    ...
    private createSynthChannel(part: SynthPartName, polyphony: number) {
        ...
        console.log(`[2a. ENGINE] Creating synth channel: ${part}`);
    ...
    public setMelodyInstrument(instrumentName: Instrument) {
        ...
        if (preset && this.nodes.has('melody')) {
            ...
            console.warn(`[2. ENGINE] Melody preset not found for: ${instrumentName}`);
        }
    }
    ...
    public setBassInstrument(instrumentName: BassInstrument) {
        ...
        if (preset) {
            ...
            console.warn(`[2. ENGINE] Bass preset not found for: ${instrumentName}`);
        }
    }
