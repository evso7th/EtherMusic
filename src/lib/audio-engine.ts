...
export class AudioEngine {
    ...
    private createPresets() {
        this.presets = {
            ...
            ebass: { type: 'FMSynth', options: { harmonicity: 1.01, modulationIndex: 5, oscillator: { type: 'sine' }, envelope: { attack: 0.05, decay: 0.1, sustain: 0.9, release: 1 }, modulation: { type: 'sine' }, modulationEnvelope: { attack: 0.02, decay: 0.1, sustain: 0.5, release: 0.8 } } },
