...
**Решение:** Мы полностью отказались от создания синтезаторов на лету в пользу архитектуры **пула (pool) независимых моносинтезаторов**, которая является стандартом в профессиональных аудио-приложениях.
